    ...
    >
        ...
        >min</p>
            ...
            <v-row
              id="capa3"
              class="ma-0 pa-0"
              style="border:3px solid rgb(39,205,122);max-width:297px;min-width:297px;border-radius:45px"
            >
              ...
              <v-row
                ...
                class="ma-0 pa-0"
                style="border:0px solid #78909C;border-radius:45px;max-width:230px;min-width:230px"
              >
                <v-row
                  id="capa4"
                  class="ma-0 pa-0"
